...
## Presentation Title: Seeking the Data-Driven Organization
...
**The point:** It seemed like what Joy was emphasizing was the urgency at which some public data is necessary. I believe she used the term, ***Data Fire Drills***. That most government organizations are able to do some basic data retrieval but systematic and structured data queries with persistence is hard to find. 

## Generally Accepted Theory of Change
...
That is to say we assume: **Building a robust data and technology system will result in better public service**

**The point:** This is probably the working theory of change for most people. I would agree with that. It assumes that the governance and users have the capacity and willingness to put the data and technology to use. This is not the case, and it is pretty clear why. 
...
- The actually reality of inter-institutional data.
    - Most data and data requests and updates are tedious back-and-forths
...
**The Point:** Default data standards had an impact on implementation and ultimately interoperability. 

### 3. Increase responsible use of roads. 

It is not enough to build it and regulate it, you need to spur increased data use and user ability.
...
Time is consumed by manual processes usually in excel. There is not time for real data engineering or maturity processes.
...
- Also referenced in talk [NOLAlytics typology](https://datadriven.nola.gov/nolalytics/)
